...
describe('ActualizarDatosContactoComponent', () => {
  let component: ActualizarDatosLaboralesComponent;
  let fixture: ComponentFixture<ActualizarDatosLaboralesComponent>;
  ...
  const cliente = {
    ...
    fixture = TestBed.createComponent(ActualizarDatosLaboralesComponent);
