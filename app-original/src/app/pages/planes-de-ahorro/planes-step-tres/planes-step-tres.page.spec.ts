...
describe('PlanesStepTresPage', () => {
  let component: PlanesStepTresPage;
  let fixture: ComponentFixture<PlanesStepTresPage>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ PlanesStepTresPage, FormatoCapitalize ],
      providers: [
        AES256, 
        FileOpener, 
        UrlSerializer, 
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PlanesStepTresPage);
  ...
  it('registrar traza', async () => {
    ...
    await component.registrarTrazabilidad(12609);
