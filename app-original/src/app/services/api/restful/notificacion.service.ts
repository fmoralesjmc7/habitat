...
export class NotificacionService {
    ...
    obtenerNotificaciones(rut: number, dv: string, cantidad: number): Observable<any> {
        const url: string = this.dominio + '/api/v1/clientes/' + rut + '-' + dv + '/notificaciones/historial?size='+ cantidad +'&page=&rutCliente=' + rut + '-' + dv + '&sort=id,desc';
