...
import { BanksResponse, Deposito, PaymentsRequest, PaymentsResponse } from 'src/app/interfaces/khipu.interface';
...
export class DepositoDirectoService {
     ...
     */
     obtenerPropositos(): Observable<any> {
        const url = this.dominioAws + '/depositodirectoback/api2/v1/cuentas/deposito-directo/propositos';
    ...
    obtenerValorMinimo(): Observable<any> {
        const url = this.dominioAws + '/depositodirectoback/api2/v1/cuentas/deposito-directo/monto_minimo_deposito';
        return this.http.get(url);
    }
    ...
    obtenerPagoKhipu(subject: string, deposito: Deposito, transaction_id: number, name: string, rut: number, dv: string): Observable<PaymentsResponse> {
     ...
     * @param dv {string}
     */
    generarTransaccion(transaccion: any, rut: number, dv: string): Observable<any> {
        const url = this.dominio + '/api/v1/clientes/' + rut + '-' + dv + '/deposito-directo/transaccion';
     ...
     */
     generarTransaccionNew(transaccion: any): Observable<any> {
        const url = this.dominioAws + '/depositodirectoback/api2/v1/cuentas/deposito-directo/confirmacion-app';
     ...
     * @param dv {string}
     */
    obtenerTransaccion(idTransaccion: number, rut: number, dv: string): Observable<any> {
        const url = this.dominio + '/api/v1/clientes/' + rut + '-' + dv + '/deposito-directo/transaccion/' + idTransaccion;
        return this.http.get(url);
    }
     ...
     * @param dv {string}
     */
    actualizarTransaccion(transaccion: any, rut: number, dv: string): Observable<any> {
        const url = this.dominio + '/api/v1/clientes/' + rut + '-' + dv + '/deposito-directo/transaccion';
     ...
     * @param dv {string}
     */
    obtenerComprobante(nroFolio: number, rut: number, dv: string): Observable<any> {
        const url = this.dominio + '/api/v1/clientes/' + rut + '-' + dv + '/deposito-directo/comprobante/' + nroFolio;
        return this.http.get(url);
    }
     ...
     * @param dv {string}
     */
    obtenerListaBancos(key): Observable<any> {
