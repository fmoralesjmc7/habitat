...
export const environment = {
  ...
  baseURL: 'https://dev-wsfront.afphabitat.cl',
  ...
  urlServiciosLogin: 'https://apiv2.dev.afphabitat.cl/oauth2/',
  dominioAws: 'apiv2.dev.afphabitat.cl',
  dominioSaldos: 'https://apiv2.dev.afphabitat.cl'
};

// Habilitar para certificacion.
export const ENV = {
  base_url: 'https://dev-wsfront.afphabitat.cl',
  base_url_aws: 'https://apiv2.dev.afphabitat.cl',
  base_url_habitat: 'https://wwwdev.afphabitat.cl',
  prudential_back: 'https://apiv2.dev.afphabitat.cl/prudentialback/api2/v1/prudential/prudentialback/'
};
