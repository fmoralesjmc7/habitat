...
describe('HomeClientePage', () => {
  ...
  const UtilServiceMock = {
    ...
    generarUuid: jest.fn(),
    getStorageData: jest.fn().mockResolvedValue('face'),
  ...
  beforeEach(fakeAsync(() => {
    TestBed.configureTestingModule({
      imports: [HomeClientePage, FormatoCapitalize, FormatoPesoChilenoPipe],
      providers: [
        UrlSerializer,
        HttpClient,
        HttpHandler,
  ...
  it('eliminación suscripción uuid', () => {
    ...
    const spySuscribe = jest.spyOn(
      component.suscripcionDatosCliente,
      'unsubscribe'
    );
  ...
  it('Formatear texto Cuenta Obligatorio', () => {
    const nombreCuenta = component.formatearNombreProducto(
      'Cuenta Obligatoria',
      'CCICO'
    );
  ...
  it('Error saldos discordantes', fakeAsync(() => {
    GiroMock.validarGiro.mockReturnValue(
  ...
  it('mostrar toast biometria', async () => {
